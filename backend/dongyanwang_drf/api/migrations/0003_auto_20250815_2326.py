# Generated by Django 3.2 on 2025-08-15 15:26
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_type', models.CharField(choices=[('journal', '学术论文'), ('project', '科研项目'), ('competition', '学科竞赛'), ('internship', '实习机会'), ('news', '行业资讯'), ('admissions', '招生机会')], max_length=20, verbose_name='内容类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post_type', models.CharField(choices=[('journal', '学术论文'), ('project', '科研项目'), ('competition', '学科竞赛'), ('internship', '实习机会'), ('news', '行业资讯'), ('admissions', '招生机会')], editable=False, max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('funding_amount', models.DecimalField(decimal_places=2, default=0, max_digits=12, verbose_name='立项经费(万元)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment_count_cache', models.BigIntegerField(default=0, verbose_name='评论数缓存')),
                ('last_activity', models.DateTimeField(auto_now=True, verbose_name='最后活跃时间')),
                ('creator', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.user', verbose_name='创建者')),
