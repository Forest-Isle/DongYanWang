# Generated by Django 4.2.23 on 2025-09-05 22:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('admissions', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='posts', to='api.admissions')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cover', models.ImageField(upload_to='competition/covers/', verbose_name='封面图')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('competition', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='posts', to='api.competition')),
                ('creator', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='创建者')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cover', models.ImageField(upload_to='', verbose_name='期刊封面')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment_count_cache', models.BigIntegerField(default=0, verbose_name='评论数缓存')),
                ('creator', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='创建者')),
                ('journal', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='posts', to='api.journal')),
            ],
            options={
                'ordering': ['-created_time'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cover', models.ImageField(blank=True, upload_to='', verbose_name='封面图')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_activity', models.DateTimeField(auto_now=True, verbose_name='最后活跃时间')),
                ('creator', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='创建者')),
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='posts', to='api.project', verbose_name='所属项目')),
            ],
            options={
                'verbose_name': '项目帖子',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cover', models.ImageField(blank=True, null=True, upload_to='', verbose_name='封面图')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment_count_cache', models.BigIntegerField(default=0, verbose_name='评论数缓存')),
                ('creator', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='创建者')),
                ('skill', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='posts', to='api.skill')),
            ],
            options={
                'ordering': ['-created_time'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Webhook 配置名称，便于识别', max_length=64)),
                ('event', models.CharField(choices=[('post_review', '帖子审核'), ('post_ban', '帖子封禁'), ('mod_removed', '移除版主'), ('export_done', '导出完成')], help_text='绑定的事件类型', max_length=32)),
                ('url', models.URLField(help_text='Webhook 接收 URL')),
                ('secret', models.CharField(blank=True, default='', help_text='可选的密钥，用于验证请求', max_length=128)),
                ('is_active', models.BooleanField(default=True, help_text='是否启用该 Webhook')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='attachments', to='api.skillpost')),
            ],
        ),
        migrations.CreateModel(
            name='SkillCategory',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='attachments', to='api.projectpost')),
            ],
            options={
                'verbose_name': '项目帖子附件',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='moderators', to='api.project')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='metrics', to='api.project')),
            ],
            options={
                'verbose_name': '项目年度指标',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('applied', '已申请'), ('approved', '已通过'), ('rejected', '已拒绝'), ('cancelled', '已取消')], default='applied', max_length=16)),
                ('motivation', models.TextField(blank=True, default='', verbose_name='申请动机')),
                ('role_expectation', models.CharField(blank=True, default='', max_length=64, verbose_name='期望角色')),
                ('created_time', models.DateTimeField(auto_now_add=True)),
                ('updated_time', models.DateTimeField(auto_now=True)),
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='enrollments', to='api.project')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='project_enrollments', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': '项目报名',
                'verbose_name_plural': '项目报名',
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['source', 'type'], name='api_project_source_d42fa8_idx')],
            },
        ),
        migrations.AddField(
            model_name='project',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('approved', '通过'), ('rejected', '拒绝'), ('banned', '封禁'), ('unbanned', '解禁')], max_length=20)),
                ('reason', models.CharField(blank=True, default='', max_length=255)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('object_id', models.PositiveIntegerField()),
                ('content_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='contenttypes.contenttype')),
                ('operator', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='moderations', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['-created_at'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('video_duration', models.PositiveIntegerField(blank=True, null=True, verbose_name='视频时长(秒)')),
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='attachments', to='api.journalpost')),
            ],
            options={
                'verbose_name': '帖子附件',
                'verbose_name_plural': '帖子附件',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('journal', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='moderators', to='api.journal')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('journal', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='metrics', to='api.journal')),
            ],
            options={
                'ordering': ['-year'],
            },
        ...
        migrations.CreateModel(
            ...
            options={
                'indexes': [models.Index(fields=['model_label', '-created_at'], name='api_hotrank_model_l_cfb148_idx')],
            },
        ),
        migrations.CreateModel(
            name='Follow',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pricing_unit', models.CharField(choices=[('per_hour', '按小时'), ('per_session', '按次')], default='per_hour', max_length=16)),
                ...
                ('provider', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='consultation_services', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': '咨询服务',
                'verbose_name_plural': '咨询服务',
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pending', '待确认'), ('confirmed', '已确认'), ('completed', '已完成'), ('cancelled', '已取消'), ('refunded', '已退款')], default='pending', max_length=16)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('buyer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='consultation_orders', to=settings.AUTH_USER_MODEL)),
                ('service', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='orders', to='api.consultationservice')),
            ],
            options={
                'verbose_name': '咨询订单',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('video_duration', models.PositiveIntegerField(blank=True, null=True, verbose_name='视频时长(秒)')),
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='attachments', to='api.competitionpost')),
            ],
            options={
                'verbose_name': '竞赛帖子附件',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(choices=[('chief', '主版主'), ('deputy', '副版主')], max_length=20, verbose_name='职位类型')),
                ('is_active', models.BooleanField(default=True, verbose_name='是否在职')),
                ('competition', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='moderators', to='api.competition')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='用户')),
            ],
            options={
                'verbose_name': '竞赛版主',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('competition', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='metrics', to='api.competition')),
            ],
            options={
                'ordering': ['-year'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('root', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='descendants', to='api.comment')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('video_duration', models.PositiveIntegerField(blank=True, null=True, verbose_name='视频时长(秒)')),
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='attachments', to='api.admissionspost')),
            ],
            options={
                'verbose_name': '招生帖子附件',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(choices=[('chief', '主版主'), ('deputy', '副版主')], max_length=20, verbose_name='职位类型')),
                ('is_active', models.BooleanField(default=True, verbose_name='是否在职')),
                ('admissions', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='moderators', to='api.admissions')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='用户')),
            ],
            options={
                'verbose_name': '招生版主',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('admissions', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='metrics', to='api.admissions')),
            ],
            options={
                'ordering': ['-year'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(choices=[('chief', '主版主'), ('deputy', '副版主')], max_length=20, verbose_name='职位类型')),
                ('is_active', models.BooleanField(default=True, verbose_name='是否在职')),
                ('skill', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='moderators', to='api.skill')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='用户')),
            ],
            options={
                'verbose_name': '技能版主',
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['project', 'status'], name='api_project_project_ce2fb7_idx'),
        ),
        migrations.AddIndex(
            model_name='projectenrollment',
            index=models.Index(fields=['user', 'status'], name='api_project_user_id_819b2c_idx'),
        ),
        migrations.AlterUniqueTogether(
            name='projectenrollment',
            unique_together={('project', 'user')},
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['content_type', 'object_id', '-created_at'], name='api_moderat_content_23c7c1_idx'),
        ),
        migrations.AddIndex(
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['provider', 'is_active'], name='api_consult_provide_511ee1_idx'),
        ),
        migrations.AddIndex(
            model_name='consultationservice',
            index=models.Index(fields=['-rating', '-rating_count'], name='api_consult_rating_dffeec_idx'),
        ),
        migrations.AddIndex(
            model_name='consultationorder',
            index=models.Index(fields=['buyer', 'status'], name='api_consult_buyer_i_d20dc6_idx'),
        ),
        migrations.AddIndex(
            model_name='consultationorder',
            index=models.Index(fields=['service', 'status'], name='api_consult_service_00fba5_idx'),
        ),
        migrations.AddIndex(
            model_name='consultationapplication',
            index=models.Index(fields=['user', 'status'], name='api_consult_user_id_c5b1cf_idx'),
        ),
        migrations.AddIndex(
            model_name='consultationapplication',
            index=models.Index(fields=['status', 'created_at'], name='api_consult_status_ab6439_idx'),
        ),
        migrations.AlterUniqueTogether(
            name='consultationapplication',
